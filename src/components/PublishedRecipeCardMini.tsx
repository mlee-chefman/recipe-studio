...
export const PublishedRecipeCardMini = ({
  recipe,
  onPress,
  isSelectionMode = false,
  isSelected = false
}: PublishedRecipeCardMiniProps) => {
        ...
        <View style={styles.imageContainer}>
          {recipe.image ? (
            ...
            <View style={[styles.image, styles.placeholderImage, { backgroundColor: appTheme.colors.gray[100] }]}>
              <Text style={{ fontSize: 30, color: appTheme.colors.gray[400] }}>🍽️</Text>
            </View>
          )}
            ...
            <View style={styles.authorContent}>
              {recipe.authorProfilePicture ? (
                ...
                <View style={[styles.authorImage, { backgroundColor: appTheme.colors.primary[100] }]}>
                  <Text style={{ fontSize: 8, color: appTheme.colors.primary[500], fontWeight: '600' }}>
